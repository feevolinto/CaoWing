...
/*
    Program Name: Weekly Cacao Usage Tracker with Full Input Validation
    Description:
    - Stores daily cacao usage for a week
    - Computes weekly average
    - Saves daily usage + weekly average to a file (with "Average:" label)
    - Allows user to view past data
    - Handles invalid input for both daily usage and yes/no choice
*/
